...
Route::delete('/habitants/{id}', [HabitantController::class, "destroy"])->name('habitants.destroy');




Route::model('villeId', Ville::class);
Route::get("/villes/{villeId}", function(Ville $ville){
    return $ville;
});
